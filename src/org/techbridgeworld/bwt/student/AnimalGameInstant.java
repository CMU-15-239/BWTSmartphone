...
public class AnimalGameInstant extends Activity implements TextToSpeech.OnInitListener {
	...
	private final BWT bwt = new BWT(this, AnimalGameInstant.this);
...
//				/*********************/
	...
	class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onFling(MotionEvent event1, MotionEvent event2,
			...
			// Swipe up
			if (fling.isUp()) {
				Intent intent = new Intent(AnimalGameInstant.this, GameActivity.class);
				bwt.stopTracking();
